//Start : Demographics
 ...
 // $.fn.dataTable.ext.errMode = 'throw';
    ...
    var demographicsdata ='{"demographicsdatatype":"demographics","logged_in_userid":"'+logged_in_userid+'","usertype":"'+usertype+'","month":"'+month+'","year":"'+year+'","risk":"'+risk+'"}';
  ...
  var usertype=sessionStorage.getItem("usertype");
  $.fn.dataTable.ext.errMode = 'throw';
    var conditionsandriskdata ='{"conditionsandriskype":"conditionsandrisk","logged_in_userid":"'+logged_in_userid+'","usertype":"'+usertype+'" ,"month":"'+month+'","year":"'+year+'","risk":"'+risk+'"}';
  ...
  function costandutilization_data()
{
  ...
  var usertype=sessionStorage.getItem("usertype");
  $.fn.dataTable.ext.errMode = 'throw';
  var costandutilizationkdata ='{"costandutilizationtype":"costandutilizationtype","logged_in_userid":"'+logged_in_userid+'","usertype":"'+usertype+'" ,"month":"'+month+'","year":"'+year+'","risk":"'+risk+'"}';
    ...
    function bcbsriprogram_data()
{
  ...
  var usertype=sessionStorage.getItem("usertype");
  $.fn.dataTable.ext.errMode = 'throw';
  var bcbsriprogramdata ='{"bcbsriprogramtype":"bcbsriprogram","logged_in_userid":"'+logged_in_userid+'","usertype":"'+usertype+'" ,"month":"'+month+'","year":"'+year+'","risk":"'+risk+'"}';
    ...
    function returnreporting_data()
{
  ...
  var usertype=sessionStorage.getItem("usertype");
  $.fn.dataTable.ext.errMode = 'throw';
  var returnreportingdata ='{"returnreportingdatatype":"returnreporting","logged_in_userid":"'+logged_in_userid+'","usertype":"'+usertype+'" ,"month":"'+month+'","year":"'+year+'","risk":"'+risk+'"}';
